...
if (arrowGroup.isTouching(redB)) {
  redB.destroyEach(); gameState=END;
  }

  if (arrowGroup.isTouching(blueB)) {
    blueB.destroyEach(); gameState=END;
    }

    if (arrowGroup.isTouching(grennB)) {
      greenB.destroyEach(); gameState=END;
      }

      if (arrowGroup.isTouching(pinkB)) {
        pinkB.destroyEach(); gameState=END;
        }
